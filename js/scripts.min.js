...
$(document).ready(function() {
    ...
    if ($(window).width() < 768 && $("div").is(".info-block__filters")
        && !$("div").is(".info-block__additional")) {
        $('.main-content').append('<div class="info-block__additional">');
        $('.info-block__additional').append( $('.info-block__items'))
    }
    ...
    $(window).resize(function () {
        ...
        if ($(window).width() > 768 && $("div").is(".info-block")
            && $("div").is(".info-block__additional")) {
            $('.info-block').append( $('.info-block__items'))
    ...
    // $('.filter-item .filter-item__header').click(
    //     function () {
    //         $(this).parent().toggleClass('open')
    //         $(this).parent().find('.filter-item__content').slideDown();
    //     }
    // )
